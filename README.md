...
```javascript
import mapReduce from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-map-reduce@v0.2.2-deno/mod.js';
```
...
[@stdlib/utils/map-reduce-right]: https://github.com/stdlib-js/utils-map-reduce-right/tree/deno
